...
export default function StakeholderDashboardPage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#020617] text-white">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-slate-950/10 via-slate-950/20 to-slate-950/60 z-[400]" />

      <div className="absolute top-6 left-6 z-[500] max-w-2xl">
        <div className="bg-slate-900/70 backdrop-blur-2xl border border-cyan-400/20 rounded-3xl px-7 py-6 shadow-2xl">
          ...
          <p className="text-slate-300 text-sm mt-3 leading-relaxed">
            Dashboard pemantauan abrasi,
            risiko pesisir, dan prioritas
            wilayah pantai Indonesia berbasis
            AI untuk stakeholder nasional.
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-6 z-[500] bg-slate-900/75 backdrop-blur-2xl border border-white/10 rounded-3xl p-5 space-y-4 min-w-[240px]">
      ...
      <div className="absolute bottom-8 right-6 z-[500] w-[340px] bg-slate-900/75 backdrop-blur-2xl border border-white/10 rounded-3xl p-5">
